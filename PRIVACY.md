...
**jira-cli** is an open-source command-line tool. It does not collect, transmit, or share any user data.

## What is stored locally

When you run `jira auth login`, the following are saved to `~/.config/jira-cli/` on your machine:
